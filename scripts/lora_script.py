...
from modules import script_callbacks, extra_networks, ui_extra_networks, sd_model_checkpoint # pylint: disable=unused-import
...
def before_ui():
    ...
    sd_model_checkpoint.extra_ui.append(create_ui)
